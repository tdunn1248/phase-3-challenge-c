...
describe('listAllGuests()', function() {
  it('should list all guests', function(done) {
...
describe('currentAndFutureBookings()', function() {
  it('lists rooms and current availability', function(done) {
    currentAndFutureBookings().then(results => {
...
describe('roomCapacityAndAvailability()', function() {
  it('lists the room bookings (room # and guest name)', function(done) {
    roomCapacityAndAvailability().then(results => {
